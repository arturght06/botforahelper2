...
headers = {
    ...
    'x-correlation-id': 'c458de33-19f9-fcf2-6319-92cdea1910ca',
    'sec-ch-ua-mobile': '?0',
    'access-token': 'YzY2N2ZkMTllNzg1YjI1NjZhMTIyYWM5Zjg3ZjJjZGU',
    'content-type': 'application/json',
    'accept': 'application/json',
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36',
    'x-request-id': '704dfca3-3d17-2da3-ac99-77725686ac7a',
